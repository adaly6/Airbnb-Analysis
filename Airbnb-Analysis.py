...
# Filter out outliers where price is greater than $2,000
df = df[df['price'] <= 2000]
...
# Calculate the average price per night for all 5 boroughs
...
# Calculate average price for the three different unit types
